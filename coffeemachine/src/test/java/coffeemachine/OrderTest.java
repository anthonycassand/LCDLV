...
//		Mockito.verify(pad, Mockito.times(1)).faux();
	...
	public void orderExtraHotTeaOneSugarOneStick() throws Exception {
		Drink d = DrinkMakerService.buyYouADrink("Th:1:0", EnumDrink.T.getPrice());
	...
	public void orderExtraHotChocolateOneSugarAndAStick() throws Exception {
		Drink d = DrinkMakerService.buyYouADrink("Hh:1:0", EnumDrink.H.getPrice());
	...
	public void orderExtraHotCoffeeNoSugar() throws Exception {
		Drink d = DrinkMakerService.buyYouADrink("Ch::", EnumDrink.C.getPrice());
	...
	public void orderOrangeJuice() throws Exception {
		Drink d = DrinkMakerService.buyYouADrink("O::", EnumDrink.O.getPrice());
	...
	public void orderOrangeJuiceNotEnoughMoney() throws Exception {
		Drink d = DrinkMakerService.buyYouADrink("O::", (EnumDrink.O.getPrice() - 0.1f));
		Assertions.assertEquals(d.toString(), "not enough money given");
	}

	@Test
	public void message() throws Exception {
		Drink d = DrinkMakerService.buyYouADrink("M:message-content", null);
	...
	public void wrongMessage() throws Exception {
		...
		try {
			DrinkMakerService.buyYouADrink("M:message-content:x:y", null);
		} catch (Exception e) {
			exception = e;
		}
